              ...
              <div class="card card-primary card-outline">
                <div class="card-body box-profile">
                  <div class="text-center">
                    <img src="<?php echo $f['fProduto'] ?>" width="100px" height="100px">
                  </div>

                  <h3 class="profile-username text-center"><?php echo $f['produto'] ?></h3>
                    ...
                    <div class="tab-pane" id="edit">
                      <form class="form-horizontal" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-10">
                            <input type="text" name="user" class="form-control" value="<?php echo $f['preco'] ?>">
                          </div>
                        </div>
                        <div class="form-group row">
                          <label for="inputName" class="col-sm-2 col-form-label">quantidade vendida</label>
                          <div class="col-sm-10">
                            <input type="text" name="pass" value="<?php echo $f['vendas'] ?>">
                          </div>
                        </div>
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-10">
                            ...
                            <br>
                            <input type="hidden" name="img1" value="<?php echo $f['fProduto'] ?>">
                          </div>
                        </div>
                        <div class="form-group row">
